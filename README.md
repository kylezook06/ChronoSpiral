...
3. Use **Left/Right** to run along the spiral and **X/Up/Space** to jump inward toward the portal. The canvas fills the window, so you can resize the browser at any point.

...
- Chrono Core (Stage 13) stays locked until you gather 60 shards; clearing it unlocks the Chrono Boss (Stage 14), an escape sprint where the spiral is visibly being sucked toward the core and the collapse accelerates the farther you run from it. Thick safe platforms help you dodge recurring electric pulses, miniature Time Warden shards scour the lanes (yanking you back without costing a life), and running into the core costs a life while reaching the glowing exit bubble at the far end of the spiral wins the fight.
